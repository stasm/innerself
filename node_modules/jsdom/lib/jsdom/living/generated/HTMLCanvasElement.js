...
HTMLCanvasElement.prototype.getContext = function getContext(contextId) {
  ...
  if (arguments.length < 1) {
    throw new TypeError(
      "Failed to execute 'getContext' on 'HTMLCanvasElement': 1 " +
...
HTMLCanvasElement.prototype.probablySupportsContext = function probablySupportsContext(contextId) {
  ...
  if (arguments.length < 1) {
    throw new TypeError(
      "Failed to execute 'probablySupportsContext' on 'HTMLCanvasElement': 1 " +
        "argument required, but only " +
        arguments.length +
        " present."
    );
...
HTMLCanvasElement.prototype.setContext = function setContext(context) {
  ...
  if (arguments.length < 1) {
    throw new TypeError(
      "Failed to execute 'setContext' on 'HTMLCanvasElement': 1 " +
        "argument required, but only " +
        arguments.length +
        " present."
    );
...
HTMLCanvasElement.prototype.toBlob = function toBlob(callback) {
  ...
  if (arguments.length < 1) {
    throw new TypeError(
      "Failed to execute 'toBlob' on 'HTMLCanvasElement': 1 " +
        "argument required, but only " +
        arguments.length +
        " present."
    );
