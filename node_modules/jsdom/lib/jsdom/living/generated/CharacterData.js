...
CharacterData.prototype.substringData = function substringData(offset, count) {
  ...
  if (arguments.length < 2) {
    throw new TypeError(
      "Failed to execute 'substringData' on 'CharacterData': 2 " +
...
CharacterData.prototype.appendData = function appendData(data) {
  ...
  if (arguments.length < 1) {
    throw new TypeError(
      "Failed to execute 'appendData' on 'CharacterData': 1 " +
...
CharacterData.prototype.insertData = function insertData(offset, data) {
  ...
  if (arguments.length < 2) {
    throw new TypeError(
      "Failed to execute 'insertData' on 'CharacterData': 2 " +
        "arguments required, but only " +
        arguments.length +
        " present."
    );
...
CharacterData.prototype.deleteData = function deleteData(offset, count) {
  ...
  if (arguments.length < 2) {
    throw new TypeError(
      "Failed to execute 'deleteData' on 'CharacterData': 2 " +
        "arguments required, but only " +
        arguments.length +
        " present."
    );
...
CharacterData.prototype.replaceData = function replaceData(offset, count, data) {
  ...
  if (arguments.length < 3) {
    throw new TypeError(
      "Failed to execute 'replaceData' on 'CharacterData': 3 " +
        "arguments required, but only " +
        arguments.length +
        " present."
    );
